...
Если вы уже получили ключ интегратора - используйте его в качестве значения заголовка X-Kontur-Ofd-ApiKey. Если ключа у вас нет - смотрите раздел :doc:`GetAccess`.
